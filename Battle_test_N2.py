    ...
    def battle(self, state={}):
        ...
        while True:
            ...
            def trial():
                ...
                input()
                print('M:"И что это значит? Делать нечего?"')
                input()
                print('Ф:"*непонимание* Нуууу... меня есть задача - доказать, что подсудимый невиновен."')
                input()
            ...
            def magneto_turn():                   
                ...
                if choice=='Затачивание металла':
                    state['sharp'] = 1
                    print('Магнето поднял металл в воздух')
                    t.sleep(1)
                    print('Он сжал руку')
                    t.sleep(1)
                    print('Все куски металла стали острыми')
